...
function biDivideModulo(x, y) {
  ...
  for (let i = n; i > t; --i) {
    ...
    const b = biMultiplyByRadixPower(y, i - t - 1);
...
function RSAKeyPair() {
  const encryptionExponent = "010001";
  const decryptionExponent = "";
  const modulus = "";
...
// Mock functions for deterministic behavior
Math.random = function () {
  return 0.5;
};

Date.prototype.getTime = function () {
  return 1745055565009;
};

function get_enc_data(name, pwd) {
  setMaxDigits(129);
  const key = new RSAKeyPair();
  const password = encryptedString(key, pwd);
  const userName = encryptedString(key, encodeURIComponent(name));
